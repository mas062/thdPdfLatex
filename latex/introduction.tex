...
\cite{foukal2006variations}. The solar radiation changes by a small amount of $0.1\%$~over a $11$ year cycle. Also on the scales of tens to thousands of years variations in the earth orbit
...
Sequestration of CO$_2$ at the ocean floor and also in deep underground aquifers (Figure \ref{fig:platform}) are some of the options available for permanent storage of $\mbox{CO}_2$. Large availability of storage volumes and potential for almost permanent storage makes the geological sequestration an appropriate option. Nevertheless, this alternative is not free from economical, social and industrial concerns.  
...
storage modeling. The injected $\mbox{CO}_2$ may travel in a large spatial scale. Providing enough geological information and the medium attributes is a big
challenge.

\textbf{User introduced uncertainty:} These type of uncertainties are caused by
the errors introduced by a user for his/her biased choice of modeling tools and
...
/ 
\end{lstlisting}
Finally and in the main part of the model, we define the simulation scenario by providing the injector completion specifications and injection plan for the well. Here we see the SCHEDULE scetion that is considered for fixed injection rate over $30$ years, followed by $70$ years of early migration. 
\begin{lstlisting}
SCHEDULE 
...
The main focus of the work is two folds:
\begin{itemize}
