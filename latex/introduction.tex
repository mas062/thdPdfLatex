...
\coo\ distribution in Figures \ref{fig:COEOI} and \ref{fig:COEOS} show that heterogeneity in case B has enhanced the lateral flow compared to case A. Direction of the flow can be seen in Figure \ref{fig:FOSEOI}. It is clear that heterogeneity can influence the imbibition and drainage process during and after injection. This, in turn, impacts the residual trapping process. The \coo\ plume can follow different paths through heterogeneities. In Figure \ref{fig:FOSEOI}a, the up-dip migration of \coo\ toward the crest pushes some volumes to move down-dip.
