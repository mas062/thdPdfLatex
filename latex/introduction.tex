...
First limitation is the SAIGUP model size. \coo\ storage studies require large models that can cover the \coo\ spatial traveling extents within aquifers. Hence, our study is limited to the domain around the injector.
